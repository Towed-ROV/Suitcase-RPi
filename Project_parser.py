...
class parser():
    ...
    def parse(self, payload_data):
        """parses a dictonary containing keys of sensor type and value
        containing sensor data. the data can handle json strings or python dicts
        returns the data in a new structure.

        Args:
            payload_data (dict or str): a dictonary or json string with sensor
                data.

...
from Storage_box_RPi4 import Storage_Box
    ...
    Can recive sensor data form different threads and save them, cann then
    send the data to a new thread as raw data or a string parsed as the project
    parsing.
...
GPS_server = gps_server(port="COM31", baudrate=9600, storage_box=box, frequency=10)
        """initilaize the system, and sets tags. :param origin: the location of
        the sotrage mox
